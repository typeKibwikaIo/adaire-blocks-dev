<?php
/**
 * Tools screen that lists recent deactivation-feedback log entries and lets
 * an admin send a one-off SendGrid test email.
 *
...
/**
 * Renders the "Adaire Blocks Deactivation Logs" Tools page.
 */
class Adaire_Deactivation_Log_Page
{
     ...
     * Singleton instance.
     *
     * @var Adaire_Deactivation_Log_Page|null
     */
    private static $instance = null;

    /**
     * Singleton access for the log page.
     *
     * @return Adaire_Deactivation_Log_Page
     */
    ...
    /**
     * Add the Tools page used for SendGrid testing.
     */
    ...
    /**
     * Render the test form and recent log table.
     */
    ...
    /**
     * Handle the SendGrid test submission.
     *
     * @return array|null
     */
    ...
    /**
     * Store the test result in the log.
     *
     * @param array  $result  Result returned by adaire_blocks_send_via_sendgrid().
     * @param string $to_email Recipient the test email was sent to.
     */
     ...
     *
     * @param array|null $test_result Result returned by handle_test_request().
     */
     ...
     *
     * @param array $logs Recent log entries, as returned by get_recent_logs().
     */
