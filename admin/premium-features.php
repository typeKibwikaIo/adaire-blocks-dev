 ...
 * 
 * This file serves as a marker to identify the premium version of GutenBlocks.
...
if (defined('WP_DEBUG') && WP_DEBUG) {
    error_log('[GutenBlocks] Premium features marker loaded - Premium version detected');
}
