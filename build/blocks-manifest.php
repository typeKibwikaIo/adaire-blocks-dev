...
return array(
	'about-us-block' => array(
		...
		'attributes' => array(
			...
			'showUpperSection' => array(
				'type' => 'boolean',
				'default' => true
			),
			'showLowerSection' => array(
				'type' => 'boolean',
				'default' => true
			),
			'upperSectionAlign' => array(
				'type' => 'string',
				'default' => 'left',
				'enum' => array(
					'left',
			...
			'showScrollButton' => array(
				'type' => 'boolean',
				'default' => true
			),
			'scrollButtonText' => array(
				'type' => 'string',
				'default' => 'Scroll'
			),
			...
			'taglineLineHeight' => array(
				'type' => 'string',
				'default' => '1.65'
			),
			'taglineLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'taglineTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'missionLineHeight' => array(
				'type' => 'string',
				'default' => '1.75'
			),
			'missionLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'missionTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'statementLineHeight' => array(
				'type' => 'string',
				'default' => '1.38'
			),
			'statementLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'statementTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			...
			'bodyTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'closingLineHeight' => array(
				'type' => 'string',
				'default' => '1.12'
			),
			'closingLetterSpacing' => array(
				'type' => 'string',
				'default' => '-0.02em'
			),
			'closingTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			)
		),
...
<rect width="24" height="24" fill="white"/>
	...
	'accordion-item-block' => array(
		...
		'description' => 'Single expandable section with title and content used inside an Accordion Block.',
		'supports' => array(
			'html' => false,
			'reusable' => false,
			'inserter' => true,
...
<rect width="24" height="24" fill="white"/>
	...
	'animation-scroll-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Scroll Animation (Free)',
		'category' => 'adaire-content-info',
		'description' => 'Add animations that appear when visitors scroll through the page.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
	...
	'app-download-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/app-download-block',
		'version' => '0.1.0',
		'title' => 'App Download',
		'category' => 'adaire-marketing-conversion',
		'description' => 'App Download block for Adaire Blocks.',
		'supports' => array(
			'html' => false,
			'anchor' => true
		),
		...
		'attributes' => array(
			...
			'text' => array(
				'type' => 'string',
				'default' => 'Promote app store links with a polished conversion section.'
			),
			'buttonText' => array(
				'type' => 'string',
			...
			'appName' => array(
				'type' => 'string',
				'default' => 'Adaire Blocks App'
			),
			'tagline' => array(
				'type' => 'string',
				'default' => 'Work anywhere'
			),
			'appStoreUrl' => array(
				'type' => 'string',
				'default' => '#'
			...
			'backgroundGradient' => array(
				'type' => 'string',
				'default' => 'linear-gradient(135deg,#111827,#3b0764)'
			),
	...
	'bento-grid-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/bento-grid-block',
		'version' => '0.1.0',
		'title' => 'Bento Grid',
		'category' => 'adaire-information-blocks',
		'description' => 'Bento-style feature grid designed for high-impact content presentation.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="22" height="22" fill="white" transform="translate(1 1)"/>
		...
		'attributes' => array(
			...
			'cards' => array(
				...
				'default' => array(
					array(
						'title' => 'Fulfilling work',
						'description' => 'Build cutting-edge tech with great client partners and team members. Solve complex problems in an environment where you have the freedom to optimize for possibilities.',
						'backgroundImageId' => 0,
						'backgroundImageUrl' => '',
						'backgroundImageAlt' => '',
						'overlayType' => 'none',
					...
					array(
						'title' => 'Remote from the start',
						'description' => 'Since the beginning we\'ve been an office-less company so you can be as ambitious in your professional life as you are in your personal life.',
						'backgroundImageId' => 0,
						'backgroundImageUrl' => '',
						'backgroundImageAlt' => '',
						'overlayType' => 'none',
					...
					array(
						...
						'description' => 'Brain space for one problem set at a time, no burdensome time sheets. High expectations for your professionalism, but total trust in you.',
						'backgroundImageId' => 0,
						'backgroundImageUrl' => '',
						'backgroundImageAlt' => '',
						'overlayType' => 'none',
					...
					array(
						'title' => 'Diverse',
						'description' => 'We foster a culture of diversity and inclusion, valuing unique perspectives and empowering everyone to thrive and contribute fully.',
						'backgroundImageId' => 0,
						'backgroundImageUrl' => '',
						'backgroundImageAlt' => '',
						'overlayType' => 'none',
	...
	'button-block' => array(
		...
		'description' => 'Create stylish call-to-action buttons with customizable styles, animations, and link destinations.',
		'example' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'call-to-action-block' => array(
		...
		'category' => 'adaire-start-actions',
		'description' => 'Create compelling call-to-action sections with customizable text, buttons, and background styling.',
		'example' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'card-scroll-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Card Slider (Free)',
		'category' => 'adaire-interactive',
		'description' => 'Display cards in a vertical scrolling layout.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="24" height="24" rx="5" fill="#D52940"/>
...
<rect width="22" height="22" fill="white" transform="translate(1 1)"/>
	...
	'card-scroll-item-block' => array(
		...
		'description' => 'Individual card with media, text, and optional button used inside a Card Slider block.',
		'supports' => array(
			'html' => false,
			'reusable' => false,
			'inserter' => true,
...
<rect width="22" height="22" fill="white" transform="translate(1 1)"/>
	...
	'case-studies-block' => array(
		...
		'title' => 'Case Studies',
		'category' => 'adaire-business',
		'description' => 'Showcase detailed customer success stories with images, results, and case study layouts.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
		...
		'attributes' => array(
			...
			'showFilters' => array(
				'type' => 'boolean',
				'default' => false,
				'description' => 'Legacy Industry/Capability dropdown filters — superseded by the Category Pills row below. Kept only for sites that already relied on it.'
			),
			'showHeader' => array(
				'type' => 'boolean',
				'default' => true
			...
			'headerHeading' => array(
				'type' => 'string',
				'default' => 'Discover inspiring case studies'
			),
			'headerDescription' => array(
				'type' => 'string',
				'default' => 'Browse real projects built by our community.'
			),
			'showSearch' => array(
				'type' => 'boolean',
				'default' => true
			...
			'submitButtonText' => array(
				'type' => 'string',
				'default' => 'Showcase your site'
			),
			'submitButtonUrl' => array(
				'type' => 'string',
				'default' => ''
			),
			'showLoadMore' => array(
...
<rect width="24" height="24" rx="5" fill="white"/>
	...
	'container-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'adaire/container-block',
		'version' => '0.1.0',
		'title' => 'Container',
		'category' => 'adaire-free',
		'description' => 'A flexible container block for wrapping content with customizable width, alignment, padding, margins, and background.',
		'example' => array(
...
<rect width="22" height="22" fill="white" transform="translate(1 1)"/>
		...
		'attributes' => array(
			...
			'responsivePaddingLeft' => array(
				'type' => 'object',
				'default' => array(
					
				)
			),
			'responsivePaddingRight' => array(
				'type' => 'object',
				'default' => array(
	...
	'content-toggle-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Content Switcher (Free)',
		'category' => 'adaire-content-tabs',
		'description' => 'Let users switch between two or more pieces of content.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" rx="5" fill="white"/>
		...
		'attributes' => array(
			...
			'pillLineHeight' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'pillLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'pillTextTransform' => array(
				'type' => 'string',
				'default' => 'none',
				'enum' => array(
					'none',
	...
	'content-toggle-panel-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Switch Content Page',
		'category' => 'adaire-content-tabs',
		'parent' => array(
			'create-block/content-toggle-block'
		),
		'description' => 'Individual content section with toggle functionality used inside a Content Switcher block.',
		'supports' => array(
			'html' => false,
			'reusable' => false,
			'inserter' => false,
...
<rect width="24" height="24" rx="5" fill="white"/>
	...
	'cookie-consent-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/cookie-consent-block',
		'version' => '0.2.0',
		'title' => 'Cookie Banner',
		'category' => 'adaire-business',
		'description' => 'GDPR/CCPA-ready cookie consent banner with category-based preferences, multiple layouts, and full style controls.',
		'keywords' => array(
			'cookie',
			'consent',
			'gdpr',
		...
		'attributes' => array(
			...
			'description' => array(
				'type' => 'string',
				'default' => 'We use cookies to enhance your browsing experience, serve personalized content, and analyze our traffic. By clicking “Accept All”, you consent to our use of cookies. You can manage your preferences at any time.'
			),
			...
			'cookiePolicyText' => array(
				'type' => 'string',
				'default' => 'Cookie Policy'
			),
			'cookiePolicyUrl' => array(
				'type' => 'string',
				'default' => '#'
			),
			'privacyPolicyText' => array(
				'type' => 'string',
			...
			'reopenButtonEnabled' => array(
				'type' => 'boolean',
				'default' => true
			),
			'reopenButtonPosition' => array(
				'type' => 'string',
				'default' => 'bottom-left',
				'enum' => array(
					'bottom-left',
			...
			'blockScriptsUntilConsent' => array(
				'type' => 'boolean',
				'default' => true
			),
			'zIndex' => array(
		...
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="5" fill="#6366F1"/><path d="M12 4C9 7 7 9.8 7 12.5A5 5 0 0 0 12 17.5A5 5 0 0 0 17 12.5C17 9.8 15 7 12 4Z" fill="white"/><circle cx="10.5" cy="11.5" r="0.9" fill="#6366F1"/><circle cx="13" cy="14" r="0.7" fill="#6366F1"/></svg>'
	),
	'cookie-notice-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		...
		'attributes' => array(
			...
			'necessaryLabel' => array(
				'type' => 'string',
				'default' => 'Strictly Necessary'
			),
			'preferencesLabel' => array(
				'type' => 'string',
				'default' => 'Preferences'
			),
			'analyticsLabel' => array(
				'type' => 'string',
				'default' => 'Analytics'
			),
			'marketingLabel' => array(
				'type' => 'string',
				'default' => 'Marketing'
			),
			'savePreferencesText' => array(
			...
			'acceptButtonColor' => array(
				'type' => 'string',
				'default' => '#6366f1'
			),
			'acceptButtonTextColor' => array(
				'type' => 'string',
				'default' => '#ffffff'
			),
			'declineButtonColor' => array(
				'type' => 'string',
				'default' => 'transparent'
			),
			'declineButtonTextColor' => array(
				'type' => 'string',
				'default' => '#f9fafb'
			),
			'linkColor' => array(
...
<circle cx="12.6" cy="11.6" r="0.8" fill="#F0F0F1"/>
	...
	'counter-block' => array(
		...
		'category' => 'adaire-marketing-conversion',
		'description' => 'Display animated statistics and key metrics with customizable styling and counting animations.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'feature-grid-free' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/feature-grid-free',
		'version' => '0.1.0',
		'title' => 'Feature Grid (Free)',
		'category' => 'adaire-information-blocks',
		'description' => 'Enhanced feature grid with additional design and layout options.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="24" height="24" rx="5" fill="#F0F0F1"/>
...
<rect width="22" height="22" fill="white" transform="translate(1 1)"/>
		...
		'attributes' => array(
			...
			'items' => array(
				...
				'default' => array(
					...
					array(
						...
						'text' => 'Track performance, understand your audience, and make smarter decisions with real-time insights.',
						'showTitle' => true
					)
				)
			),
			...
			'responsiveItemBorderRadius' => array(
				'type' => 'object',
				'default' => array(
					'mobile' => '12px',
					'tablet' => '12px',
	...
	'flipcard-back-block' => array(
		...
		'description' => 'Back side of a Flip Card revealed on hover with additional content.',
		'supports' => array(
			'html' => false,
			'reusable' => false,
			'inserter' => false,
...
<rect width="24" height="24" fill="white"/>
	...
	'flipcard-block' => array(
		...
		'title' => 'Flip Card',
		'category' => 'adaire-interactive',
		'description' => 'Interactive card that flips to reveal additional information.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_77_2)">
<rect width="24" height="24" rx="5" fill="#D52940"/>
<g clip-path="url(#clip1_77_2)">
...
<rect width="24" height="24" fill="white"/>
		...
		'attributes' => array(
			...
			'frontBackgroundImageUrl' => array(
				'type' => 'string',
				'default' => ''
			),
			'frontBackgroundImageId' => array(
				'type' => 'number',
				'default' => 0
			),
			'backBackgroundImageUrl' => array(
				'type' => 'string',
				'default' => ''
			),
			'backBackgroundImageId' => array(
				'type' => 'number',
				'default' => 0
			),
			'entranceAnimationEnabled' => array(
				'type' => 'boolean',
				'default' => false
			),
			'entranceAnimationType' => array(
				'type' => 'string',
				'default' => 'fade-in',
				'enum' => array(
					'fade-in',
			...
			'entranceAnimationDistance' => array(
				'type' => 'number',
				'default' => 50
			),
			'entranceAnimationThreshold' => array(
				'type' => 'number',
				'default' => 0.2
			),
			'entranceAnimationOnce' => array(
				'type' => 'boolean',
				'default' => false
			),
			'entranceAnimationReverseOnScrollOut' => array(
				'type' => 'boolean',
				'default' => false
			)
		)
	...
	'flipcard-front-block' => array(
		...
		'description' => 'Front side of a Flip Card with customizable content and styling.',
		'supports' => array(
			'html' => false,
			'reusable' => false,
			'inserter' => false,
...
<rect width="24" height="24" fill="white"/>
	...
	'form-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/form-block',
		'version' => '0.1.0',
		'title' => 'Booking Form',
		'category' => 'adaire-business',
		'description' => 'Booking Form block for Adaire Blocks.',
		'supports' => array(
			'html' => false,
			'anchor' => true
		),
		...
		'attributes' => array(
			...
			'text' => array(
				'type' => 'string',
				'default' => 'Collect visitor details and preferred appointment dates.'
			),
			'buttonText' => array(
				'type' => 'string',
				'default' => 'Book now'
			...
			'services' => array(
				'type' => 'string',
				'default' => 'Consultation, Demo, Support'
			),
			'calendarEmbedUrl' => array(
				'type' => 'string',
				'default' => ''
			),
			'successMessage' => array(
				'type' => 'string',
				'default' => 'Thanks, your booking request was received.'
			),
			'redirectUrl' => array(
				'type' => 'string',
				'default' => ''
...
<path d="M8.8 16.6L11.6 13.6L13.6 15.4L16 12.6L19.2 16.6" stroke="#F0F0F1" stroke-width="1.3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
	...
	'header-menu-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/header-menu-block',
		'version' => '0.1.0',
		'title' => 'Header Menu (Free)',
...
<rect x="3" y="16" width="18" height="1.6" rx="0.8" fill="#D52940"/>
		...
		'attributes' => array(
			...
			'responsiveNavOrientation' => array(
				'type' => 'object',
				'default' => array(
					
				)
			),
			'responsiveShowNav' => array(
				'type' => 'object',
				'default' => array(
					
				)
			),
			'responsiveNavFontWeight' => array(
				'type' => 'object',
				'default' => array(
					
				)
			),
			'responsiveLetterSpacing' => array(
				'type' => 'object',
				'default' => array(
					
				)
			),
			'responsiveTextTransform' => array(
				'type' => 'object',
				'default' => array(
			...
			'topBarFontSize' => array(
				'type' => 'number',
				'default' => 13
			),
			'responsiveTopBarFontSize' => array(
				'type' => 'object',
				'default' => array(
			...
			'mobileLogoWidth' => array(
				'type' => 'number',
				'default' => 120
			),
			'responsiveMobileLogoWidth' => array(
				'type' => 'object',
				'default' => array(
			...
			'responsiveNavSpacing' => array(
				'type' => 'object',
				'default' => array(
					
				)
			),
			'mobileMenuStyle' => array(
				'type' => 'string',
				'default' => 'dropdown',
				'enum' => array(
					'dropdown',
			...
			'mobileSlideDirection' => array(
				'type' => 'string',
				'default' => 'right'
			),
			'hamburgerIconStyle' => array(
				'type' => 'string',
				'default' => 'bars'
			),
			...
			'mobileCloseOnOutsideClick' => array(
				'type' => 'boolean',
				'default' => true
			),
			'mobileCloseOnEscape' => array(
				'type' => 'boolean',
				'default' => true
			),
			'showCta' => array(
			...
			'hamburgerBorder' => array(
				'type' => 'boolean',
				'default' => false
			),
			'hamburgerBorderColor' => array(
				'type' => 'string',
				'default' => '#e5e7eb'
			),
			'hamburgerBorderRadius' => array(
				'type' => 'number',
				'default' => 10
			),
			'hamburgerPosition' => array(
				'type' => 'string',
				'default' => 'left',
				'enum' => array(
					'left',
			...
			'signInTextColor' => array(
				'type' => 'string',
				'default' => '#6366f1'
			),
			'signInBorderColor' => array(
				'type' => 'string',
				'default' => '#6366f1'
			),
			'signInFontSize' => array(
				'type' => 'number',
				'default' => 16
			),
			'signUpBgColor' => array(
			...
			'signUpTextColor' => array(
				'type' => 'string',
				'default' => '#ffffff'
			),
			'signUpBorderColor' => array(
				'type' => 'string',
				'default' => '#6366f1'
			),
			'signUpFontSize' => array(
				'type' => 'number',
				'default' => 16
			),
			'ctaBgColor' => array(
			...
			'AdaireBlocksMargin' => array(
				'type' => 'object',
				'default' => array(
					
				)
			),
			'AdaireBlocksPadding' => array(
				'type' => 'object',
				'default' => array(
			...
			'showSignInIcon' => array(
				'type' => 'boolean',
				'default' => true
			),
			'showSignUpIcon' => array(
				'type' => 'boolean',
				'default' => true
			),
			'showCtaIcon' => array(
			...
			'ctaHoverBgColor' => array(
				'type' => 'string',
				'default' => ''
			),
			'ctaHoverTextColor' => array(
				'type' => 'string',
				'default' => ''
			),
			...
			'ctaPaddingVertical' => array(
				'type' => 'number',
				'default' => -1
			),
			'ctaPaddingHorizontal' => array(
				'type' => 'number',
				'default' => -1
			),
			...
			'buttonPaddingVertical' => array(
				'type' => 'number',
				'default' => 4
			),
			'searchLayoutStyle' => array(
				'type' => 'string',
				'default' => 'icon-only',
				'enum' => array(
					'icon-only',
			...
			'searchInputBgColor' => array(
				'type' => 'string',
				'default' => ''
			),
			'searchInputBorderColor' => array(
				'type' => 'string',
				'default' => ''
			),
			'searchInputTextColor' => array(
				'type' => 'string',
				'default' => ''
			),
			...
			'searchContainerBgColor' => array(
				'type' => 'string',
				'default' => ''
			),
			'socialPlacement' => array(
				'type' => 'string',
				'default' => 'actions',
				'enum' => array(
					'actions',
			...
			'topBarFollowEnabled' => array(
				'type' => 'boolean',
				'default' => true
			),
			'topBarFollowText' => array(
				'type' => 'string',
				'default' => 'Follow us'
			),
			'topBarFollowUrl' => array(
				'type' => 'string',
				'default' => ''
			),
			'topBarFollowIcon' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'topBarFollowIconPosition' => array(
				'type' => 'string',
				'default' => 'left',
				'enum' => array(
					'left',
			...
			'paymentIconPlacement' => array(
				'type' => 'string',
				'default' => 'actions'
			),
			'paymentIconSize' => array(
				'type' => 'number',
				'default' => 22
			),
			'paymentIconColor' => array(
				'type' => 'string',
				'default' => ''
			)
		)
	...
	'hero-1-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Hero Banner (Legacy)',
		'category' => 'adaire-layout-hero',
		'description' => 'Legacy registration kept only so pages saved before the create-block/hero-1-block → create-block/hero-banner-block rename keep rendering and editing correctly. Not for new use — insert "Hero (Free)" instead.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'customClassName' => true,
...
<path d="M14.3275 8.00586H4.75979C4.64862 8.00586 4.5585 8.09598 4.5585 8.20715V8.20903C4.5585 8.3202 4.64862 8.41031 4.75979 8.41031H14.3275C14.4387 8.41031 14.5288 8.3202 14.5288 8.20903V8.20715C14.5288 8.09598 14.4387 8.00586 14.3275 8.00586Z" fill="#D52940"/>
		...
		'attributes' => array(
			...
			'responsiveBackgroundGradient' => array(
				...
				'default' => array(
					...
					'smartwatch' => 'linear-gradient(90deg,rgb(3,0,46) 0%,rgb(31,0,87) 100%)'
				)
			),
	...
	'hero-banner-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/hero-banner-block',
		'version' => '0.1.0',
		'title' => 'Hero (Free)',
		'category' => 'adaire-layout-hero',
		'description' => 'Create large introductory hero sections with headings, text, and call-to-action buttons.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'customClassName' => true,
...
<path d="M14.3275 8.00586H4.75979C4.64862 8.00586 4.5585 8.09598 4.5585 8.20715V8.20903C4.5585 8.3202 4.64862 8.41031 4.75979 8.41031H14.3275C14.4387 8.41031 14.5288 8.3202 14.5288 8.20903V8.20715C14.5288 8.09598 14.4387 8.00586 14.3275 8.00586Z" fill="#D52940"/>
		...
		'attributes' => array(
			...
			'responsiveBackgroundType' => array(
				'type' => 'object',
				'default' => array(
					'desktop' => 'gradient',
					'tablet' => 'gradient',
			...
			'responsiveBackgroundColor' => array(
				'type' => 'object',
				'default' => array(
					'desktop' => '#03002e',
					'tablet' => '#03002e',
	...
	'horizontal-scroll-card-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/horizontal-scroll-card-block',
		'version' => '0.1.0',
		'title' => 'Horizontal Scroll Card',
		'category' => 'adaire-effects-interactions',
		'parent' => array(
			'create-block/horizontal-scroll-carousel-block'
		),
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="5" fill="#7C3AED"/><rect x="4" y="5" width="16" height="14" rx="2" fill="white" opacity="0.15"/><rect x="4" y="5" width="16" height="14" rx="2" stroke="white" stroke-width="1.5"/><rect x="7" y="8" width="5" height="2" rx="1" fill="white"/><rect x="7" y="12" width="8" height="1.5" rx="0.75" fill="white" opacity="0.7"/><rect x="7" y="15" width="4" height="1.5" rx="0.75" fill="white" opacity="0.5"/></svg>',
		'description' => 'A single card for the Horizontal Scroll Carousel block.',
		'supports' => array(
			'html' => false,
			'reusable' => false,
			'inserter' => false,
		...
		'attributes' => array(
			'cardTitle' => array(
				'type' => 'string',
				'default' => 'Your Card Title'
			),
			'cardText' => array(
				'type' => 'string',
				'default' => 'Add your card description here.'
			),
			'imageId' => array(
				'type' => 'number',
				'default' => 0
	...
	'horizontal-scroll-carousel-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/horizontal-scroll-carousel-block',
		'version' => '0.1.0',
		'title' => 'Horizontal Scroll Carousel',
		'category' => 'adaire-effects-interactions',
		'description' => 'A scroll-driven horizontal carousel. Scroll down to slide cards left, scroll up to reverse. Powered by GSAP ScrollTrigger.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="5" fill="#7C3AED"/><rect x="3" y="8" width="7" height="8" rx="1.5" fill="white"/><rect x="12" y="8" width="7" height="8" rx="1.5" fill="white" opacity="0.5"/><path d="M4 12H1.5" stroke="white" stroke-width="1.5" stroke-linecap="round"/><path d="M3 10.5L1.5 12L3 13.5" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M20 12H22.5" stroke="white" stroke-width="1.5" stroke-linecap="round"/><path d="M21.5 10.5L23 12L21.5 13.5" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
	...
	'icon-box-block' => array(
		...
		'title' => 'Icon Box (Free)',
		'category' => 'adaire-content-info',
		'description' => 'Display features, services, or benefits with customizable icons, titles, and descriptions in a grid layout.',
		'example' => array(
		...
		'attributes' => array(
			...
			'iconName' => array(
				'type' => 'string',
				'default' => 'lightning-charge-fill'
			),
			'chosenIcon' => array(
				'type' => 'string',
				'default' => 'bi bi-lightning-charge-fill'
			),
			'iconColor' => array(
				'type' => 'string',
				'default' => '#ffffff'
			...
			'description' => array(
				'type' => 'string',
				'default' => 'Blazing performance with zero compromises — built for modern teams that move fast.'
			),
			'showButton' => array(
				'type' => 'boolean',
				'default' => true
...
<rect width="24" height="24" fill="white"/>
	...
	'image-composition-block' => array(
		...
		'title' => 'Image Collage',
		'category' => 'adaire-layout-sections',
		'description' => 'Create artistic image layouts with overlapping photos, creative positioning, and visual storytelling.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
...
<path d="M2.48936 17.4784C2.37651 17.4784 2.26827 17.4345 2.18847 17.3563C2.10866 17.2782 2.06383 17.1722 2.06383 17.0617V16.8784L2.70213 16.2534V15.37L2.06383 15.995V4.97835C2.06383 4.86785 2.10866 4.76187 2.18847 4.68373C2.26827 4.60559 2.37651 4.56169 2.48936 4.56169H19.5106C19.6235 4.56169 19.7317 4.60559 19.8115 4.68373C19.8913 4.76187 19.9362 4.86785 19.9362 4.97835V5.18669H21V4.94294C21 4.75608 20.9624 4.57105 20.8894 4.39841C20.8164 4.22578 20.7093 4.06891 20.5744 3.93678C20.4394 3.80465 20.2792 3.69984 20.1029 3.62833C19.9266 3.55683 19.7376 3.52002 19.5468 3.52002H2.46596C2.27337 3.51975 2.08261 3.55669 1.90463 3.62873C1.72665 3.70077 1.56493 3.80649 1.42875 3.93983C1.29256 4.07318 1.18459 4.23153 1.11102 4.4058C1.03745 4.58008 0.999721 4.76686 1 4.95544V17.0971C1 17.284 1.03759 17.469 1.11062 17.6416C1.18365 17.8143 1.29069 17.9711 1.42563 18.1033C1.56057 18.2354 1.72077 18.3402 1.89708 18.4117C2.07339 18.4832 2.26236 18.52 2.45319 18.52H2.70213V17.4784H2.48936Z" fill="#D52940"/>
	...
	'industries-block' => array(
		...
		'category' => 'adaire-business',
		'description' => 'Display industries, sectors, or business categories with icons and descriptions.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'infogrid-3-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Feature Grid Pro (Legacy)',
		'category' => 'adaire-information-blocks',
		'description' => 'Advanced feature grid with richer layouts and styling.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="24" height="24" rx="5" fill="#D52940"/>
...
<path d="M17.1689 5.01631C17.2195 4.74438 17.0718 4.48499 16.839 4.43694C16.6061 4.3889 16.3763 4.5704 16.3256 4.84234C16.275 5.11427 16.4227 5.37366 16.6556 5.4217C16.8884 5.46975 17.1183 5.28824 17.1689 5.01631Z" fill="white"/>
	...
	'infogrid-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Feature Grid (Pro)',
		'category' => 'adaire-information-blocks',
		'description' => 'Display features, services, or information in a responsive grid layout with customizable styling.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
...
<path d="M17.207 9.06111C17.2845 8.65466 17.0585 8.26697 16.7022 8.19518C16.346 8.1234 15.9943 8.3947 15.9168 8.80116C15.8393 9.20761 16.0653 9.5953 16.4216 9.66709C16.7778 9.73887 17.1295 9.46757 17.207 9.06111Z" fill="#D52940"/>
	...
	'live-streamer-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/live-streamer-block',
		'version' => '0.1.0',
		'title' => 'Live Streamer',
		'category' => 'adaire-media-videos',
		'description' => 'Live Streamer block for Adaire Blocks.',
		'supports' => array(
			'html' => false,
			'anchor' => true
		),
		...
		'attributes' => array(
			...
			'heading' => array(
				'type' => 'string',
				'default' => 'Watch the live stream'
			),
			'text' => array(
				'type' => 'string',
				'default' => 'Embed or link to streams from YouTube, Facebook, Instagram, TikTok, Snapchat, and more.'
			),
			'buttonText' => array(
				'type' => 'string',
				'default' => 'Watch live'
			...
			'offlineMessage' => array(
				'type' => 'string',
				'default' => 'We are offline. Check back for the next stream.'
			),
			'offlineImage' => array(
				'type' => 'string',
				'default' => ''
			...
			'viewerCount' => array(
				'type' => 'string',
				'default' => '1.2k watching'
			),
			'nextStreamDate' => array(
				'type' => 'string',
				'default' => ''
			),
			'autoRefresh' => array(
	...
	'location-map' => array(
		...
		'title' => 'Location Map',
		'category' => 'adaire-business',
		'description' => 'Showcase one or more business locations on an interactive Google Map. Visitors click a location in the list to fly the map to that address and see its contact details, or show a single map with one address. Fully customizable colors, container width, and spacing.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'logos-block' => array(
		...
		'description' => 'Display partner, sponsor, or client logos in a grid or carousel layout.',
		'example' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'mega-menu-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Mega Menu',
		'category' => 'adaire-hero-sections',
		'description' => 'Create advanced navigation menus with categories, columns, icons, and rich content sections.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
		...
		'attributes' => array(
			...
			'ribbonLinkArrowEnabled' => array(
				'type' => 'boolean',
				'default' => false
			),
			'ribbonLinkArrowColor' => array(
				'type' => 'string',
				'default' => ''
			),
			'ribbonLinkArrowSize' => array(
				'type' => 'number',
				'default' => 16
			),
			'ribbonLinkArrowRotation' => array(
				'type' => 'number',
				'default' => 0
			),
			'centerMenu' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'mega-menu-item' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'adaire/mega-menu-item',
		'version' => '0.1.0',
		'title' => 'GutenBlocks Mega Menu Item',
		'category' => 'adaire-layout-navigation',
		'parent' => array(
			'core/navigation'
		),
		'description' => 'Attaches a centrally managed GutenBlocks mega panel to a Core Navigation block. Content lives in the Mega Menu dashboard — this block only controls placement and presentation.',
		'supports' => array(
			'html' => false,
			'reusable' => false,
			'typography' => array(
		...
		'attributes' => array(
			...
			'closeOnLinkSelect' => array(
				'type' => 'boolean',
				'default' => true
			),
			'keepOnlyOneOpen' => array(
				'type' => 'boolean',
				'default' => true
			),
			'mobileMode' => array(
			...
			'mobilePanelPadding' => array(
				'type' => 'number',
				'default' => 16
			),
			'mobileSubmenuIndent' => array(
				'type' => 'number',
				'default' => 16
			),
			'lockBodyScroll' => array(
				'type' => 'boolean',
				'default' => true
			),
			'mobileLabel' => array(
	...
	'our-process-block' => array(
		...
		'title' => 'Process Steps',
		'category' => 'adaire-business',
		'description' => 'Show a step-by-step process, workflow, or journey.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" rx="5" fill="white"/>
	...
	'particles-block' => array(
		...
		'category' => 'adaire-effects-interactions',
		'description' => 'Create engaging page backgrounds with interactive moving particles and customizable animation effects.',
		'example' => array(
		...
		'attributes' => array(
			...
			'sectionIntroTitle' => array(
				'type' => 'string',
				'default' => 'Meet the Team'
			),
			'sectionIntroDescription' => array(
				'type' => 'string',
...
<rect width="24" height="24" fill="white"/>
	...
	'pdf-reader-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/pdf-reader-block',
		'version' => '0.1.0',
		'title' => 'PDF Reader',
		'category' => 'adaire-media',
		'description' => 'Upload a PDF and display it as an embedded, readable viewer with download and open-in-new-tab actions.',
		'supports' => array(
			'html' => false,
			'anchor' => true
		),
		...
		'attributes' => array(
			...
			'heading' => array(
				'type' => 'string',
				'default' => 'Read the PDF'
			),
			'text' => array(
				'type' => 'string',
				'default' => 'Share a PDF resource, brochure, guide, or document.'
			),
			'buttonText' => array(
				'type' => 'string',
			...
			'fallbackMessage' => array(
				'type' => 'string',
				'default' => 'No PDF has been uploaded yet.'
			),
			'viewerHeight' => array(
				'type' => 'number',
				'default' => 640
...
<path d="M9 18.4H12.8" stroke="#111827" stroke-width="1" stroke-linecap="round"/>
	...
	'pdf-upload-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/pdf-upload-block',
		'version' => '0.1.0',
		'title' => 'PDF Upload',
		'category' => 'adaire-media',
		'description' => 'PDF Upload block for Adaire Blocks.',
		'supports' => array(
			'html' => false,
			'anchor' => true
		),
		...
		'attributes' => array(
			...
			'fallbackMessage' => array(
				'type' => 'string',
				'default' => 'PDF preview is unavailable. Please download the file.'
			),
			'thumbnailUrl' => array(
				'type' => 'string',
				'default' => ''
	...
	'popup-modal-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/popup-modal-block',
		'version' => '0.1.0',
		'title' => 'Popup Modal',
		'category' => 'adaire-marketing-conversion',
		'description' => 'A trigger button that opens a customizable popup modal with animations, positioning, and free-form content.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
		...
		'attributes' => array(
			...
			'backdropBlurEnabled' => array(
				'type' => 'boolean',
				'default' => false
			),
			'backdropBlurAmount' => array(
				'type' => 'number',
				'default' => 8
			),
			'autoOpen' => array(
			...
			'floatingOffsetX' => array(
				'type' => 'number',
				'default' => 24
			),
			'floatingOffsetY' => array(
				'type' => 'number',
				'default' => 24
			),
			...
			'triggerBorderRadius' => array(
				'type' => 'number',
				'default' => 8
			),
			'triggerPaddingX' => array(
				'type' => 'number',
				'default' => 20
			),
			'triggerPaddingY' => array(
				'type' => 'number',
				'default' => 12
			),
			'triggerFontSize' => array(
				'type' => 'number',
				'default' => 16
			),
			'triggerFontWeight' => array(
				'type' => 'string',
				'default' => '600'
			),
			'modalLayout' => array(
			...
			'autoOpenScrollPercent' => array(
				'type' => 'number',
				'default' => 50
			),
			'autoOpenInactivitySeconds' => array(
				'type' => 'number',
				'default' => 30
			),
			'autoOpenEventName' => array(
				'type' => 'string',
				'default' => 'adaire-modal-open'
			),
			'autoOpenElementSelector' => array(
				'type' => 'string',
				'default' => ''
			),
			'showFrequency' => array(
			...
			'glassmorphismEnabled' => array(
				'type' => 'boolean',
				'default' => false
			),
			'overlayGradientEnabled' => array(
				'type' => 'boolean',
				'default' => false
			),
			'overlayGradientColor2' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'portfolio-block' => array(
		...
		'category' => 'adaire-business',
		'description' => 'Display portfolio projects, products, or completed work with images and descriptions.',
		'example' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'posts-carousel-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Blog Post Slider (Free)',
		'category' => 'adaire-blog-content',
		'description' => 'Display WordPress blog posts in a sliding carousel with navigation controls.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'posts-grid-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Blog Post Grid (Free)',
		'category' => 'adaire-blog-content',
		'description' => 'Display WordPress blog posts in a responsive grid with customizable layouts and filters.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
		...
		'attributes' => array(
			...
			'headingResponsiveLineHeight' => array(
				'type' => 'object',
				'default' => array(
					'mobile' => '1.15',
					'tablet' => '1.15',
			...
			'headingResponsiveLetterSpacing' => array(
				'type' => 'object',
				'default' => array(
					'mobile' => 'normal',
					'tablet' => 'normal',
...
<rect width="24" height="24" fill="white"/>
	...
	'pricing-comparison-block' => array(
		...
		'category' => 'adaire-marketing-conversion',
		'description' => 'Compare pricing plans with feature tables, audience tabs, and a sticky choose-plan bar.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
		...
		'attributes' => array(
			...
			'subheadingText' => array(
				'type' => 'string',
				'default' => 'Adaire Blocks website builder'
			),
			'linkText' => array(
				'type' => 'string',
				'default' => 'Discover Adaire Blocks Pro'
			),
			'linkUrl' => array(
				'type' => 'string',
				'default' => '#'
					...
					array(
						...
						'plans' => array(
							...
							array(
								...
								'highlight' => true,
								'metaItems' => array(
									'25,000 monthly Adaire Blocks credits',
									'1 site'
								)
							)
						),
			...
			'cardTitleFontSize' => array(
				'type' => 'string',
				'default' => '18px'
			),
			'cardTitleFontWeight' => array(
				'type' => 'string',
				'default' => '600'
			),
			'cardTitleLineHeight' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'cardTitleLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'cardTitleTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'cardDescriptionFontSize' => array(
				'type' => 'string',
				'default' => '14px'
			),
			'cardDescriptionFontWeight' => array(
				'type' => 'string',
				'default' => '400'
			),
			'cardDescriptionLineHeight' => array(
				'type' => 'string',
				'default' => '1.5'
			),
			'cardDescriptionLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'cardDescriptionTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'priceFontSize' => array(
			...
			'featureLabelFontSize' => array(
				'type' => 'string',
				'default' => '13px'
			),
			'featureLabelFontWeight' => array(
				'type' => 'string',
				'default' => '500'
			),
			'featureLabelLineHeight' => array(
				'type' => 'string',
				'default' => '1.4'
			),
			'featureLabelLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'featureLabelTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'featureSectionTitleFontSize' => array(
				'type' => 'string',
				'default' => '11px'
			),
			'featureSectionTitleFontWeight' => array(
				'type' => 'string',
				'default' => '700'
			),
			'featureSectionTitleLineHeight' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'featureSectionTitleLetterSpacing' => array(
				'type' => 'string',
				'default' => '0.08em'
			),
			'featureSectionTitleTextTransform' => array(
				'type' => 'string',
				'default' => 'uppercase'
			),
			'guaranteeFontSize' => array(
				'type' => 'string',
				'default' => '14px'
			),
			'guaranteeFontWeight' => array(
				'type' => 'string',
				'default' => '400'
			),
			'guaranteeLineHeight' => array(
				'type' => 'string',
				'default' => '1.5'
			),
			'guaranteeLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'guaranteeTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			)
		),
...
<rect width="24" height="24" fill="white"/>
	...
	'pricing-table-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Pricing Plans (Free)',
		'category' => 'adaire-marketing-conversion',
		'description' => 'Showcase pricing packages, subscriptions, or service plans.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
		...
		'attributes' => array(
			...
			'subheading' => array(
				'type' => 'string',
				'default' => 'Choose the plan that best fits your project.'
			),
			'cards' => array(
				'type' => 'array',
				'default' => array(
			...
			'toggleFontWeight' => array(
				'type' => 'string',
				'default' => '400'
			),
			'toggleLineHeight' => array(
				'type' => 'string',
				'default' => '1.2'
			),
			'toggleLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'toggleTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			...
			'planNameFontWeight' => array(
				'type' => 'string',
				'default' => '700'
			),
			'planNameLineHeight' => array(
				'type' => 'string',
				'default' => '1.08'
			),
			'planNameLetterSpacing' => array(
				'type' => 'string',
				'default' => '-0.03em'
			),
			'planNameTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'planTaglineFontSize' => array(
				'type' => 'object',
				'default' => array(
					'desktop' => array(
						'value' => 14,
			...
			'planTaglineFontWeight' => array(
				'type' => 'string',
				'default' => '400'
			),
			'planTaglineLineHeight' => array(
				'type' => 'string',
				'default' => '1.45'
			),
			'planTaglineLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'planTaglineTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'pricePrefixFontWeight' => array(
				'type' => 'string',
				'default' => '500'
			),
			'pricePrefixLineHeight' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'pricePrefixLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'pricePrefixTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'priceFontWeight' => array(
			...
			'priceSuffixFontWeight' => array(
				'type' => 'string',
				'default' => '400'
			),
			'priceSuffixLineHeight' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'priceSuffixLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'priceSuffixTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'featureFontWeight' => array(
				'type' => 'string',
				'default' => '400'
			),
			'featureLineHeight' => array(
				'type' => 'string',
				'default' => '1.45'
			),
			'featureLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'featureTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
	...
	'progress-block' => array(
		...
		'title' => 'Progress Bar',
		'category' => 'adaire-information-blocks',
		'description' => 'Showcase skills, stats, or completion levels as a list of labeled progress bars or a grid of circular progress rings, with an optional heading.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" rx="5" fill="white"/>
		...
		'attributes' => array(
			...
			'subheading' => array(
				'type' => 'string',
				'default' => 'A quick snapshot of where we\'re strongest.'
			),
			'headingAlign' => array(
				'type' => 'string',
				'default' => 'left',
			...
			'items' => array(
				...
				'default' => array(
					...
					array(
						'label' => 'Clothing design skills',
						'value' => 90,
						'color' => ''
					),
					array(
						'label' => 'Cutting skills',
						'value' => 75,
						'color' => ''
					),
					array(
						'label' => 'Pattern-making skills',
						'value' => 92,
						'color' => ''
					)
				)
	...
	'project-block' => array(
		...
		'category' => 'adaire-business',
		'description' => 'Display project previews with image galleries and project details.',
		'example' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'promo-banner-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/promo-banner-block',
		'version' => '0.1.0',
		'title' => 'Promo Banner',
		'category' => 'adaire-marketing',
		'description' => 'Promo Banner block for Adaire Blocks.',
		'supports' => array(
			'html' => false,
			'anchor' => true
		),
		...
		'attributes' => array(
			...
			'heading' => array(
				'type' => 'string',
				'default' => 'Save 30% today'
			),
			'text' => array(
				'type' => 'string',
				'default' => 'Highlight promotions, announcements, and campaign messages.'
			),
			'buttonText' => array(
				'type' => 'string',
				'default' => 'Claim offer'
	...
	'questions-block' => array(
		...
		'title' => 'FAQ Section',
		'category' => 'adaire-content-expandable',
		'description' => 'Display frequently asked questions with expandable answers for better content organization.',
		'example' => array(
...
<path d="M9 16.8L7.6 21.2L12 19.4L16.4 21.2L15 16.8Z" fill="#D52940"/>
	...
	'reader-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/reader-block',
		'version' => '0.1.0',
		'title' => 'Reader',
		'category' => 'adaire-blog-publishing',
		'description' => 'Reader block for Adaire Blocks.',
		'supports' => array(
			'html' => false,
			'anchor' => true
		),
		...
		'attributes' => array(
			...
			'text' => array(
				'type' => 'string',
				'default' => 'Create a focused reader card for articles, notes, or resources.'
			),
			'buttonText' => array(
				'type' => 'string',
				'default' => 'Read more'
			...
			'cards' => array(
				...
				'default' => array(
					array(
						...
						'excerpt' => 'A short guide to product clarity, systems, and conversion.',
						'author' => 'Adaire Blocks Team',
						'date' => '2026-06-06',
	...
	'row-block' => array(
		...
		'attributes' => array(
			...
			'responsiveColumnWidths' => array(
				'type' => 'object',
				'default' => array(
					
				)
			),
			'responsiveDirection' => array(
				'type' => 'object',
				'default' => array(
			...
			'animationReverseOnScrollOut' => array(
				'type' => 'boolean',
				'default' => false
			)
		)
	),
	'saas-hero-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/saas-hero-block',
		'version' => '0.2.0',
		'title' => 'Hero Block (Pro)',
		'category' => 'adaire-layout-hero',
		'description' => 'Hero block for Adaire Blocks.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'customClassName' => true
		...
		'attributes' => array(
			...
			'singleButtonText' => array(
				'type' => 'string',
				'default' => 'Shop Collection'
			),
			'singleButtonUrl' => array(
				'type' => 'string',
				'default' => '#'
			),
			'microCopy' => array(
			...
			'buttonPrimaryColor' => array(
				'type' => 'string',
				'default' => '#ffffff'
			),
			'buttonPrimaryBg' => array(
				'type' => 'string',
				'default' => '#6366f1'
			),
			'buttonSecondaryColor' => array(
				'type' => 'string',
				'default' => '#111827'
			),
			'buttonSecondaryBg' => array(
				'type' => 'string',
				'default' => '#ffffff'
			),
			'buttonHoverColor' => array(
			...
			'effectDotPattern' => array(
				'type' => 'boolean',
				'default' => false
			),
			'effectGradientOverlay' => array(
				'type' => 'boolean',
				'default' => false
			),
			'effectGradientOverlayColor1' => array(
				'type' => 'string',
				'default' => '#6366f1'
			),
			'effectGradientOverlayColor2' => array(
				'type' => 'string',
				'default' => '#8b5cf6'
			),
			'effectGradientOverlayOpacity' => array(
				'type' => 'number',
				'default' => 30
			),
			'effectAbstractShapes' => array(
				'type' => 'boolean',
				'default' => false
			),
			'effectGlow' => array(
			...
			'effectFloatingElements' => array(
				'type' => 'boolean',
				'default' => false
			),
			'effectAnimatedAccents' => array(
				'type' => 'boolean',
				'default' => false
			),
			'showRatingBadges' => array(
				'type' => 'boolean',
				'default' => false
			),
			'ratingBadgesAlignment' => array(
				'type' => 'string',
				'default' => 'center'
			),
			'ratingBadges' => array(
			...
			'eyebrowFontSize' => array(
				'type' => 'string',
				'default' => '14px'
			),
			'eyebrowFontWeight' => array(
				'type' => 'string',
				'default' => '600'
			),
			'eyebrowLineHeight' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'eyebrowLetterSpacing' => array(
				'type' => 'string',
				'default' => '1px'
			),
			'eyebrowTextTransform' => array(
				'type' => 'string',
				'default' => 'uppercase'
			),
			'headingFontSize' => array(
			...
			'bodyTextLineHeight' => array(
				'type' => 'string',
				'default' => '1.6'
			),
			'bodyTextLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'bodyTextTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'bodyTextFontWeight' => array(
				'type' => 'string',
				'default' => '400'
			),
			'pillFontSize' => array(
			...
			'microCopyFontSize' => array(
				'type' => 'string',
				'default' => '14px'
			),
			'microCopyFontWeight' => array(
				'type' => 'string',
				'default' => '400'
			),
			'microCopyLineHeight' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'microCopyLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'microCopyTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			)
		),
...
<rect x="8.5" y="14.2" width="7" height="3.6" rx="1.8" fill="#D52940"/>
	...
	'scroll-text-block' => array(
		...
		'category' => 'adaire-content-info',
		'description' => 'Display animated scrolling text banners with customizable speed, direction, and styling.',
		'example' => array(
		...
		'attributes' => array(
			'heroText' => array(
				'type' => 'string',
				'default' => 'Hello from Adaire Blocks x GSAP!'
			),
			'backgroundColor' => array(
				'type' => 'string',
				'default' => '#ffffff'
...
<rect width="24" height="24" fill="white"/>
	...
	'services-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Animated Content Carousel',
		'category' => 'adaire-business',
		'description' => 'Showcase any content — services, projects, features — as an animated carousel with multiple layout modes (vertical, horizontal, full-screen, split).',
		'example' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'skill-bar-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'create-block/skill-bar-block',
		'version' => '0.1.0',
		'title' => 'Skill Bar',
		'category' => 'adaire-information-blocks',
		'description' => 'Skill Bar block for Adaire Blocks.',
		'supports' => array(
			'html' => false,
			'anchor' => true
		),
		...
		'attributes' => array(
			...
			'text' => array(
				'type' => 'string',
				'default' => 'Showcase progress, expertise, or completion using a clean animated bar.'
			),
			'buttonText' => array(
				'type' => 'string',
				'default' => '85%'
			...
			'skills' => array(
				...
				'default' => array(
					...
					array(
						...
						'description' => 'Frontend and WordPress'
					)
				)
			),
	...
	'social-banner-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Social Banner (Free)',
		'category' => 'adaire-social-engagement',
		'description' => 'Display social media links in a floating or fixed banner with customizable styling.',
		'example' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'social-share-block' => array(
		...
		'attributes' => array(
			...
			'platformFontSize' => array(
				'type' => 'number',
				'default' => 14
			),
			'platformFontWeight' => array(
				'type' => 'string',
				'default' => '400',
				'enum' => array(
					'100',
			...
			'platformLineHeight' => array(
				'type' => 'string',
				'default' => '1.4'
			),
			'platformLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'platformTextTransform' => array(
				'type' => 'string',
				'default' => 'none',
				'enum' => array(
					'none',
			...
			'responsivePlatformFontSize' => array(
				'type' => 'object',
				'default' => array(
...
<rect width="24" height="24" fill="white"/>
		...
		'description' => 'Showcase images in a touch-friendly slider with navigation arrows, dots, and autoplay options.',
		'supports' => array(
			'html' => false,
			'align' => array(
				'full',
	...
	'swiper-slide-block' => array(
		...
		'description' => 'Individual slide with customizable content inside an Image Slider or Video Carousel.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_94_3)">
<rect width="24" height="24" rx="5" fill="#F0F0F1"/>
<g clip-path="url(#clip1_94_3)">
...
<rect width="24" height="24" fill="white"/>
	...
	'tab-panel-block' => array(
		...
		'description' => 'Content panel displayed when a specific tab is selected in the Tabbed Content block.',
		'supports' => array(
			'html' => false,
			'reusable' => false,
			'inserter' => false,
...
<rect width="24" height="24" fill="white"/>
	...
	'tabs-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Tabbed Content (Free)',
		'category' => 'adaire-content-tabs',
		'description' => 'Organize content into clickable tabs or pill-style switchers with smooth transitions and custom styling for better page organization.',
		'keywords' => array(
			'tabs',
			'switcher',
			'toggle',
...
<rect width="24" height="24" fill="white"/>
	...
	'testimonial-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Reviews (Free)',
		'category' => 'adaire-testimonial',
		'description' => 'Display customer testimonials with quotes, author info, and ratings to build trust.',
		'example' => array(
...
<rect width="24" height="24" fill="white"/>
		...
		'attributes' => array(
			...
			'scrollEffectDuration' => array(
				'type' => 'number',
				'default' => 700
			),
			'scrollEffectStagger' => array(
				'type' => 'number',
				'default' => 120
			),
			'scrollEffectOnce' => array(
				'type' => 'boolean',
				'default' => true
			),
			'arrowColor' => array(
			...
			'testimonials' => array(
				...
				'default' => array(
					...
					array(
						...
						'companyLogo' => '',
						'quote' => 'This platform has completely transformed how we approach our online presence. The quality and attention to detail exceeded every expectation we had going in.',
						'authorName' => 'Sarah Chen',
						'authorTitle' => 'Director of Marketing at Acme Corp'
					),
					array(
						'companyName' => 'Meridian Labs',
						'companyLogo' => '',
						'quote' => 'Outstanding results from day one. Our team productivity increased by 40% and client satisfaction scores have never been higher.',
						'authorName' => 'James Okonkwo',
						'authorTitle' => 'Head of Product at Meridian Labs'
					)
				)
			),
			'responsivePaddingTop' => array(
			...
			'quoteLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'quoteTextTransform' => array(
				'type' => 'string',
				'default' => 'none',
				'enum' => array(
					'none',
			...
			'authorTitleFontSize' => array(
				'type' => 'string',
				'default' => '14px'
			),
			'authorTitleFontWeight' => array(
				'type' => 'string',
				'default' => '400',
				'enum' => array(
					'300',
			...
			'authorTitleLineHeight' => array(
				'type' => 'string',
				'default' => '1.5'
			),
			'authorTitleLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'authorTitleTextTransform' => array(
				'type' => 'string',
				'default' => 'none',
				'enum' => array(
					'none',
			...
			'companyNameTextTransform' => array(
				'type' => 'string',
				'default' => 'none',
				'enum' => array(
					'none',
	...
	'testimonial2-block' => array(
		...
		'title' => 'Review Slider',
		'category' => 'adaire-testimonial',
		'description' => 'Display customer reviews in a carousel layout.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
	...
	'testimonial3-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Pro Testimonials',
		'category' => 'adaire-testimonial',
		'description' => 'Advanced customer review section with enhanced layouts and styling.',
		'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
	...
	'timeline-block' => array(
		...
		'attributes' => array(
			...
			'sectionTitleFontWeight' => array(
				'type' => 'string',
				'default' => '700'
			),
			'sectionTitleLineHeight' => array(
				'type' => 'string',
				'default' => '1.18'
			),
			'sectionTitleLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'sectionTitleTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'sectionDescFontSize' => array(
				'type' => 'string',
				'default' => '16px'
			),
			'sectionDescFontWeight' => array(
				'type' => 'string',
				'default' => '400'
			),
			'sectionDescLineHeight' => array(
				'type' => 'string',
				'default' => '1.75'
			),
			'sectionDescLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'sectionDescTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'itemTitleFontSize' => array(
			...
			'itemTitleLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'itemTitleTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'itemTitleColor' => array(
			...
			'itemDescFontSize' => array(
				'type' => 'string',
				'default' => '15px'
			),
			'itemDescFontWeight' => array(
				'type' => 'string',
				'default' => '400'
			),
			'itemDescLineHeight' => array(
				'type' => 'string',
				'default' => '1.75'
			),
			'itemDescLetterSpacing' => array(
				'type' => 'string',
				'default' => 'normal'
			),
			'itemDescTextTransform' => array(
				'type' => 'string',
				'default' => 'none'
			),
			'responsivePaddingTop' => array(
...
<circle cx="12" cy="17.5" r="1" fill="#F0F0F1"/>
	...
	'video-carousel-block' => array(
		...
		'title' => 'Video Gallery',
		'category' => 'adaire-media-videos',
		'description' => 'Display multiple videos in a grid or carousel layout with thumbnails and custom playback controls.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'video-hero-block' => array(
		...
		'title' => 'Video Banner',
		'category' => 'adaire-layout-hero',
		'description' => 'Create stunning hero sections with video backgrounds, overlay text, and call-to-action buttons.',
		'example' => array(
...
<rect width="24" height="24" fill="white"/>
	...
	'video-player-block' => array(
		...
		'version' => '0.1.0',
		'title' => 'Video Player (Free)',
		'category' => 'adaire-media-videos',
		'description' => 'Embed and play videos from YouTube, Vimeo, or upload your own video files with customizable controls.',
		'supports' => array(
			'html' => false,
			'anchor' => true,
			'align' => array(
		...
		'attributes' => array(
			...
			'containerBorderEnabled' => array(
				'type' => 'boolean',
				'default' => false
			),
			'containerShadowIntensity' => array(
				'type' => 'number',
				'default' => 0
			),
			'marginTop' => array(
