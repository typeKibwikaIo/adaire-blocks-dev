...
* Added Horizontal Scroll Card Block (Plus, nested) - slides inside the carousel with title, body, image, shadows, borders, responsive spacing, and inner button blocks (Adaire Blocks Button and/or core buttons)
