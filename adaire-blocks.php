 ...
 * Version:           Guten-Blocks-release-1.3.4
...
define('ADAIRE_BLOCKS_VERSION', 'Guten-Blocks-release-1.3.4');
...
function adaire_render_license_notice($block_name)
{
    ...
    ">
        ...
        <a href="<?php echo esc_url($license_page_url); ?>" class="button button-primary" style="text-decoration: none;">
            Activate License
        </a>
    </div>
    <?php
...
function render_counter_block($attributes)
{
    ...
    return adaire_render_block_with_notice('counter-block', $attributes, function ($attrs) {
        ...
        ob_start();
        ?>
        <div class="ab-counter-block counter-block" style="<?php echo esc_attr($style_string); ?>"
            data-block-id="<?php echo esc_attr($block_id); ?>" data-starting-number="<?php echo esc_attr($starting_number); ?>"
            data-ending-number="<?php echo esc_attr($ending_number); ?>" data-duration="<?php echo esc_attr($duration); ?>"
            data-delay-bool="<?php echo esc_attr($delay_bool ? 'true' : 'false'); ?>"
            data-delay-time="<?php echo esc_attr($delay_time); ?>"
            data-counter-direction="<?php echo esc_attr($counter_direction); ?>" data-prefix="<?php echo esc_attr($prefix); ?>"
            ...
            <div class="ab-counter-block__container <?php echo esc_attr($container_class); ?>">
                ...
                <div class="ab-counter-block__content" style="text-align: center;">
                    <span class="ab-counter-block__number"
                        ...
                        <?php if ($prefix): ?><span
                                class="ab-counter-block__prefix"><?php echo esc_html($prefix); ?></span><?php endif; ?>
                        <span class="displayNumber"><?php echo esc_html($starting_number); ?></span>
                        <?php if ($suffix): ?><span
                                class="ab-counter-block__suffix"><?php echo esc_html($suffix); ?></span><?php endif; ?>
                    </span>
                </div>
...
{
    // Use the helper function to automatically handle upgrade notices
    return adaire_render_block_with_notice(
        'mega-menu-block',
        $attributes,
        function ($attrs, $inner_content) {
            ...
            $render_cta_button = function ($extra_class = '', $is_mobile = false) use ($ctaButtonEnabled, $ctaButtonText, $ctaButtonLink, $ctaButtonOpenInNewTab, $ctaButtonShowIcon, $ctaButtonStyle, $ctaButtonHoverAnimation, $ctaMobileUseSeparateStyles, $ctaMobileButtonStyle, $ctaMobileButtonHoverAnimation, $ctaMobileButtonShowIcon) {
                if (!$ctaButtonEnabled) {
                    return '';
                }
                ...
                ob_start();
                ?>
            <a class="<?php echo esc_attr(implode(' ', $classes)); ?>" href="<?php echo esc_url($ctaButtonLink ?: '#'); ?>"
                <?php if ($ctaButtonOpenInNewTab): ?> target="_blank" rel="noopener noreferrer" <?php endif; ?>>
            ...
            ?>
        <div class="<?php echo esc_attr(implode(' ', $root_classes)); ?>" style="<?php echo esc_attr($style_string); ?>"
            ...
            <div class="adaire-mega-menu__container testagain">
                        ...
                        <div class="adaire-mega-menu__ribbon-content">
                            ...
                            <?php if (!empty($ribbonLinkUrl)): ?>
                                <a class="adaire-mega-menu__ribbon-link" href="<?php echo esc_url($ribbonLinkUrl); ?>" <?php if ($ribbonLinkOpenInNewTab): ?>target="_blank" rel="noopener noreferrer" <?php endif; ?>>
                                    <span
                                        class="adaire-mega-menu__ribbon-link-label"><?php echo esc_html($ribbonLinkLabel ?: __('Learn more', 'mega-menu-block')); ?></span>
                ...
                <?php endif; ?>
                <nav
                    class="adaire-mega-menu__navbar <?php echo ($containerMode === 'constrained' ? 'is-constrained' : ''); ?> <?php echo ($containerMode === 'constrained' && $centerMenu ? 'center-menu' : ''); ?>">
                    <div class="adaire-mega-menu__brand">
                        <a class="adaire-mega-menu__brand-link" href="<?php echo esc_url($logo_link_url ?: '/'); ?>">
                            <?php if ($menuImageAtTop): ?>
                                <img src="<?php echo esc_url($menuImageAtTop); ?>" alt="<?php echo esc_attr($menuImageAtTopAlt); ?>"
                        ...
                        <ul class="adaire-mega-menu__mega-menu">
                            <?php
                                ...
                                <li class="adaire-mega-menu__dropdown">
                                    <a href="<?php echo esc_url($item_url); ?>" class="adaire-mega-menu__dropdown-header" <?php
                                            ...
                                            <div class="<?php echo esc_attr(implode(' ', $menu_classes)); ?>">
                                                <?php if ($item_canvas_banner_enabled): ?>
                                                    <div class="adaire-mega-menu__menu__banner">
                                                        <h1 class="adaire-mega-menu__menu__banner__title"><?php echo esc_html($item_title); ?>
                                                        </h1>
                                                ...
                                                <ul class="adaire-mega-menu__menu__list">
                                                    ...
                                                    <?php foreach ($item_children as $child):
                                                        ...
                                                        <li class="adaire-mega-menu__sub-dropdown">
                                                            <a href="<?php echo esc_url($child_url); ?>"
                                                                class="adaire-mega-menu__sub-dropdown-header" <?php if ($child_open_in_new_tab): ?>target="_blank" rel="noopener noreferrer" <?php endif; ?>
                                                                    ...
                                                                    <?php foreach ($child_children as $grandchild):
                                                                        ...
                                                                        <li>
                                                                            <a href="<?php echo esc_url($grandchild_url); ?>"
                                                                                ...
                                                                                <?php if ($grandchild_open_in_new_tab): ?>target="_blank"
                                                    ...
                                                    <?php if ($should_render_canvas_story): ?>
                                                        <?php if ($canvasStoryDividerEnabled): ?>
                                                            <li class="adaire-mega-menu__canvas-divider adaire-mega-menu__canvas-divider--<?php echo esc_attr($item_canvas_image_position); ?>"
                                                                aria-hidden="true"></li>
                                                        <?php endif; ?>
                                                        <li
                                                            class="adaire-mega-menu__canvas-story adaire-mega-menu__canvas-story--<?php echo esc_attr($item_canvas_image_position); ?>">
                                                            ...
                                                            <?php if ('' !== trim((string) $item_canvas_story_link_label)): ?>
                                                                <a class="adaire-mega-menu__canvas-story-link"
                                                                    href="<?php echo esc_url($item_canvas_story_link_url ?: '#'); ?>" <?php if ($item_canvas_story_link_new_tab): ?>target="_blank" rel="noopener noreferrer"
                                                                    <?php endif; ?>>
