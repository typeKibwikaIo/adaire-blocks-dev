		...
		<div class="ab-counter-block__container <?php echo esc_attr( $container_class ); ?>">
			...
			<div class="ab-counter-block__content" style="text-align: center;">
				<span class="ab-counter-block__number"
					...
					if ( $prefix ) :
						?>
						<span class="ab-counter-block__prefix"><?php echo esc_html( $prefix ); ?></span><?php endif; ?>
					<span class="displayNumber"><?php echo esc_html( $starting_number ); ?></span>
					<?php
					if ( $suffix ) :
						?>
						<span class="ab-counter-block__suffix"><?php echo esc_html( $suffix ); ?></span><?php endif; ?>
				</span>
			</div>
...
function render_mega_menu_block( $attributes, $content ) {
	...
	return adaire_render_block_with_notice(
		...
		function ( $attrs, $inner_content ) {
			...
			$level1HoverPadding                  = $attrs['level1HoverPadding'] ?? array(
				'top'    => 10,
				'right'  => 5,
				'bottom' => 10,
				'left'   => 5,
			...
			$level2HoverPadding                  = $attrs['level2HoverPadding'] ?? array(
				'top'    => 8,
				'right'  => 12,
				'bottom' => 8,
				'left'   => 12,
			...
			$level3HoverPadding                  = $attrs['level3HoverPadding'] ?? array(
				'top'    => 8,
				'right'  => 12,
				'bottom' => 8,
				'left'   => 12,
			...
			$containerMaxWidth                   = $attrs['containerMaxWidth'] ?? array(
				'desktop' => array(
					'value' => 1200,
					'unit'  => 'px',
				),
			...
			$padding                             = $attrs['padding'] ?? array(
				'top'    => 20,
				'right'  => 20,
				'bottom' => 20,
				'left'   => 20,
			);
			$margin                              = $attrs['margin'] ?? array(
				'top'    => 0,
				'right'  => 0,
				'bottom' => 0,
				'left'   => 0,
			...
			$mobileImmersiveButtonRowPadding     = $attrs['mobileImmersiveButtonRowPadding'] ?? array(
				'top'    => 0,
				'right'  => 0,
				'bottom' => 32,
				'left'   => 0,
					...
					<div class="adaire-mega-menu__ribbon">
						<div class="adaire-mega-menu__ribbon-content">
							...
							<?php if ( ! empty( $ribbonLinkUrl ) ) : ?>
								<a class="adaire-mega-menu__ribbon-link" href="<?php echo esc_url( $ribbonLinkUrl ); ?>" 
								<?php
								if ( $ribbonLinkOpenInNewTab ) :
									?>
												...
												<li class="adaire-mega-menu__canvas-story adaire-mega-menu__canvas-story--<?php echo esc_attr( $item_canvas_image_position ); ?>">
													...
													<?php if ( '' !== trim( (string) $item_canvas_story_link_label ) ) : ?>
														<a class="adaire-mega-menu__canvas-story-link"
															...
															<?php
															if ( $item_canvas_story_link_new_tab ) :
																?>
																target="_blank" rel="noopener noreferrer"<?php endif; ?>>
