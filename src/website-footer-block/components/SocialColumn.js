...
export default function SocialColumn({ attributes, setAttributes, isSelected }) {
    const {
        socialItems,
        displayStyle,
        iconSize,
    ...
    const columnProps = useBlockProps({
        className: 'website-footer-block__column website-footer-block__column--social',
        style: { textAlign }
    });
    ...
    return (
        <div {...columnProps}>
            <ul 
                className={`website-footer-block__social-list website-footer-block__social-list--${displayStyle}`}
                style={{ '--icon-size': `${iconSize}px` }}
            >
                {socialItems.map((item, index) => (
                    <li 
                        key={item.id} 
                        className="website-footer-block__social-item"
                    >
                        {displayStyle === 'vertical' ? (
                            <RichText
                                tagName="a"
                                className="website-footer-block__social-link"
                                value={item.label}
