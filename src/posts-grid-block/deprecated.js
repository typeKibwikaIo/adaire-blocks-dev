/**
 * Blog Post Grid (posts-grid-block) deprecations — most recent first.
 *
 ...
 *     font family) for the block's heading text — unconditionally, for
 *     every instance, regardless of whether the user ever opens the new
 *     typography controls in the "Heading" panel. Posts saved before that
 *     change don't have those custom properties in their stored markup, so
