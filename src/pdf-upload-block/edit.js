  ...
  return (<>
    <InspectorControls>
      <PanelBody title={__('Content', 'adaire-blocks')} initialOpen={true}>
        ...
        {media(__('PDF file', 'adaire-blocks'), a.pdfUrl, (v) => setAttributes({ pdfUrl: v }), ['application/pdf'])}<TextControl label={__('File size', 'adaire-blocks')} value={a.fileSize || ''} onChange={set(setAttributes, 'fileSize')} /><TextControl label={__('Page count', 'adaire-blocks')} value={a.pageCount || ''} onChange={set(setAttributes, 'pageCount')} /><TextControl label={__('Password hint', 'adaire-blocks')} value={a.passwordHint || ''} onChange={set(setAttributes, 'passwordHint')} /><ToggleControl label={__('Show download button', 'adaire-blocks')} checked={!!a.showDownload} onChange={set(setAttributes, 'showDownload')} /><RangeControl label={__('Viewer height', 'adaire-blocks')} value={a.viewerHeight || 640} onChange={set(setAttributes, 'viewerHeight')} min={240} max={1200} />
      </PanelBody>
      ...
      <PanelBody title={__('Responsive', 'adaire-blocks')} initialOpen={false}>
        ...
        <RangeControl label={__('Radius', 'adaire-blocks')} value={radius[deviceType] ?? radius.desktop ?? a.borderRadius ?? 18} onChange={(v) => updateResponsive('responsiveBorderRadius', v)} min={0} max={80} />
      </PanelBody>
    </InspectorControls>
