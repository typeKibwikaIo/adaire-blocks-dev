...
// v1: pre-"remove yearly pricing" save — included a monthly/yearly billing
// toggle, a per-card yearlyPrice, and a yearly badge. Frozen here so pages
// saved with that markup still validate; migrate() drops the yearly-only
// attributes so upgraded blocks match the current (monthly-only) schema.
