...
export default function Save({ attributes }) {
    ...
    return (
        <div {...blockProps}>
            {overlayType !== 'none' && (
                <div
                    className={`adaire-hero-banner-overlay is-type-${overlayType}`}
                />
            )}
            {showBreadcrumbs && (
                <nav className="adaire-hero-banner__breadcrumbs" aria-label={__('Breadcrumb', 'adaire-blocks')}>
            ...
            {mediaType === 'video' || mediaType === 'image' ? (
                <div className="adaire-hero-banner__content-video-wrapper">
                    <div className="adaire-hero-banner__cta-container">
                        {showPreheader && (
                            <div className="adaire-hero-banner__preheader">
                                {preheaderText}
                            </div>
                        )}
                        ...
                        <p className="adaire-hero-banner__text">
                            {textContent}
                        </p>
            ...
            {showIcon && iconImageUrl && (
                <div className="adaire-hero-banner__icon" data-icon-position={iconPosition} data-icon-vertical-position={iconVerticalPosition}>
