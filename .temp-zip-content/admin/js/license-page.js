/**
 * License Management JavaScript for AdaireBlocks Blocks
 *
    ...
    class AdaireLicenseManager {
        ...
        activateLicense(licenseKey) {
            ...
            this.performActivation(licenseKey)
                ...
                .catch(error => {
                    console.error('[AdaireBlocks License] Activation Process Error:', {
                        error: error,
        ...
        validateLicenseForActivation(licenseKey) {
            return new Promise((resolve, reject) => {
                        ...
                        try {
                            ...
                            if (response.ok && jsonData.success) {
                                if (jsonData.data && jsonData.data.errors) {
                                    ...
                                    console.error('[AdaireBlocks License] Validation Error:', {
                                ...
                                console.error('[AdaireBlocks License] Validation Failed:', {
                            ...
                            console.error('[AdaireBlocks License] Validation Parse Error:', {
                                error: e,
                                responseText: text,
                                url: fullUrl,
                                status: response.status
                ...
                .catch(error => {
                    console.error('[AdaireBlocks License] Validation Network Error:', {
                        error: error,
                        message: error.message,
                        stack: error.stack,
                        url: fullUrl
        ...
        validateAfterActivation(licenseKey) {
            return new Promise((resolve, reject) => {
                    ...
                    return response.text().then(text => {
                        try {
                            ...
                            if (response.ok && jsonData.success) {
                                ...
                                console.error('[AdaireBlocks License] Post-Activation Validation Failed:', {
                                    message: jsonData.message,
                                    fullResponse: jsonData,
                                    url: fullUrl,
                                    status: response.status,
                            ...
                            console.error('[AdaireBlocks License] Post-Activation Validation Parse Error:', {
                                error: e,
                                responseText: text,
                                url: fullUrl,
                                status: response.status
                ...
                .catch(error => {
                    console.error('[AdaireBlocks License] Post-Activation Validation Network Error:', {
                        error: error,
                        message: error.message,
                        stack: error.stack,
                        url: fullUrl
        ...
        performActivation(licenseKey) {
            return new Promise((resolve, reject) => {
                        ...
                        try {
                            ...
                            if (response.ok && jsonData.success) {
                                if (jsonData.data && jsonData.data.errors) {
                                    ...
                                    console.error('[AdaireBlocks License] Activation Error:', {
                                        errorMessages: errorMessages,
                                        fullResponse: jsonData,
                                        url: fullUrl,
                                        status: response.status
                                    ...
                                    if (token) {
                                        ...
                                        console.error('[AdaireBlocks License] Activation Failed - No Token:', {
                                            fullResponse: jsonData,
                                            url: fullUrl,
                                            status: response.status
                                        });
                                    ...
                                    console.error('[AdaireBlocks License] Activation Failed - No Data:', {
                                        fullResponse: jsonData,
                                        url: fullUrl,
                                        status: response.status
                                    });
                                ...
                                console.error('[AdaireBlocks License] Activation Failed:', {
                                    message: jsonData.message,
                                    fullResponse: jsonData,
                                    url: fullUrl,
                                    status: response.status,
                            ...
                            console.error('[AdaireBlocks License] Activation Parse Error:', {
                                error: e,
                                responseText: text,
                                url: fullUrl,
                                status: response.status
                ...
                .catch(error => {
                    console.error('[AdaireBlocks License] Activation Network Error:', {
                        error: error,
                        message: error.message,
                        stack: error.stack,
                        url: fullUrl
        ...
        deactivateLicense() {
                    ...
                    try {
                        ...
                        if (response.ok && jsonData.success) {
                            ...
                            if (jsonData.data && jsonData.data.errors) {
                                ...
                                console.error('[AdaireBlocks License] Deactivation Error:', {
                                    errorMessages: errorMessages,
                                    fullResponse: jsonData,
                                    url: fullUrl,
                                    status: response.status
                            ...
                            console.error('[AdaireBlocks License] Deactivation Failed:', {
                                message: jsonData.message,
                                fullResponse: jsonData,
                                url: fullUrl,
                                status: response.status,
                        ...
                        console.error('[AdaireBlocks License] Deactivation Parse Error:', {
                            error: e,
                            responseText: text,
                            url: fullUrl,
                            status: response.status
            ...
            .catch(error => {
                console.error('[AdaireBlocks License] Deactivation Network Error:', {
                    error: error,
                    message: error.message,
                    stack: error.stack,
                    url: fullUrl
        ...
        saveDeactivationResult() {
            ...
            $.ajax({
                ...
                error: (xhr, status, error) => {
                    console.error('[AdaireBlocks License] Save Deactivation AJAX Error:', {
                        xhr: xhr,
                        status: status,
                        error: error,
		...
		updateLicenseData(validationData) {
            ...
            $.ajax({
                ...
                error: (xhr, status, error) => {
                    console.error('[AdaireBlocks License] Update License Data AJAX Error:', {
                        xhr: xhr,
                        status: status,
                        error: error,
                        responseText: xhr.responseText,
		...
		saveActivationResult(licenseKey, activationData) {
            ...
            $.ajax({
                ...
                error: (xhr, status, error) => {
                    console.error('[AdaireBlocks License] Save Activation AJAX Error:', {
                        xhr: xhr,
                        status: status,
                        error: error,
                        responseText: xhr.responseText,
				...
				$actionsCardContent.html(
					`<form id="adaire-license-form" class="adaire-license-form">
						<div class="adaire-license-input-group">
							...
							<p class="description">Enter your AdaireBlocks Blocks license key to activate the plugin.</p>
						</div>
						<div class="adaire-license-actions">
		...
		formatDate(dateStr) {
			try {
				...
				console.log('AdaireBlocks Blocks License: Date formatting error:', e, dateStr);
				return dateStr;
			}
		}
