/**
 * AdaireBlocks Blocks Admin Settings JavaScript
 */
            ...
            window.wp.apiFetch({ url: ajaxData.restUrl })
                .then(function(response) {
                    if (!response || !response.success) {
                        console.error('AdaireBlocks Blocks Registry validation failed', response);
                        return;
                    }

                    if (response.validation && response.validation.errors && response.validation.errors.length) {
                        console.error('AdaireBlocks Blocks Registry validation errors', response.validation.errors);
                    } else {
                        console.info('AdaireBlocks Blocks Registry validation passed', {
                ...
                .catch(function(error) {
                    console.error('AdaireBlocks Blocks Registry API request failed', error);
                });
        }
