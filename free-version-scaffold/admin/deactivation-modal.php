...
class Adaire_Deactivation_Modal {
	...
	private function __construct() {
		...
		add_action( 'admin_enqueue_scripts', array( $this, 'load_modal_assets' ) );
		add_action( 'wp_ajax_adaire_deactivation_feedback', array( $this, 'handle_feedback' ) );
	}
	...
	public function handle_feedback() {
		...
		wp_send_json_success( array( 'sent' => $send_result['sent'] ) );
	}
	...
	private function log_feedback_attempt( array $feedback, array $send_result, $feedback_recipient ) {
		$existing_logs = get_option( 'adaire_deact_log', array() );
