...
class AdaireBlocksSettings {
    ...
    public function init_settings() {
        ...
        //     error_log('GutenBlocks Settings: ' . print_r($this->settings, true));
        // }
    }
    ...
    public function sanitize_settings($input) {
        ...
        // if (defined('WP_DEBUG') && WP_DEBUG) {
        //     error_log('GutenBlocks Sanitize Input: ' . print_r($input, true));
        // }
        ...
        // if (defined('WP_DEBUG') && WP_DEBUG) {
        //     error_log('GutenBlocks Sanitized Output: ' . print_r($sanitized, true));
        // }
    ...
    public function get_available_blocks() {
        ...
        foreach ($directories as $dir) {
            ...
            // if (defined('WP_DEBUG') && WP_DEBUG) {
            //     error_log("GutenBlocks Settings: Block $block_name - enabled: " . ($config->is_block_enabled($block_name) ? 'true' : 'false') . ", premium: " . ($is_premium_block ? 'true' : 'false'));
            // }
    ...
    private function log_registration_failure($message) {
        if (defined('WP_DEBUG') && WP_DEBUG) {
            error_log('GutenBlocks Registry: ' . $message);
        }
    }
    ...
    public function settings_page() {
        ...
        if (!$config) {
            wp_die('Error: GutenBlocks configuration not loaded. Please try refreshing the page.');
        }
        
        // // Debug: Log config status (only in debug mode)
        // if (defined('WP_DEBUG') && WP_DEBUG) {
        //     error_log('GutenBlocks Settings: Config loaded - is_premium: ' . ($config->is_premium() ? 'true' : 'false'));
        //     error_log('GutenBlocks Settings: Plugin version: ' . $config->get_plugin_version());
        // }
                                        ...
                                        <div class="adaire-block-toggle">
                                            <?php if ($block_data['is_premium']): ?>
                                                <div class="adaire-block-note">
                                                    <a href="https://adaireblocks.com/shop-blocks" target="_blank" class="adaire-hidden-upgrade-button">
